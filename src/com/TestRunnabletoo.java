...
public class TestRunnabletoo implements Runnable{
	...
	public void run() {	 
		...
		start=a.getTime();
			 ...
			 try {
				...
				cpu1=0;
					if(count==100){
						System.out.println("cpu平均:"+cpu2/100.0);
					}
					Date b=new Date();
					end=b.getTime();
					...
					if(count==100){
						System.out.println("平均响应时间:"+task_time/99.0);
					}
				Shell.exec("172.16.1.73", "ubuntu", "ubuntu", 22, "mysql -uroot -proot -e \"use test;call proc1;\"");
