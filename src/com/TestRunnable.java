...
public class TestRunnable implements Runnable{
	...
	public static Integer[] software;
	private String flavorid;
	private int disk;
	private String neicun;
	private String neihe;
	private StringBuffer logininfo;
	public static double cpu1=0;
	public static double cpu2=0;
	public static int count=0;
	public static double count1=0;
	public static double count2=0;
	public static double task_time=0;
	/*
	 * 数据归一化 得到归一化之后的数据矩阵
	 */
	...
	public void run() {	 
		...
		System.out.println("1");
			 //System.out.println(hostname+flavor+image+software.length);
			 String systemname="";
			 ...
			 try {
				...
				if(time_min!=t0){
					...
					if(ip_target.equals("172.16.1.73")){
					...
					if(count==40){
						System.out.println("73:"+count1+"74:"+count2);
						System.out.println("cpu平均:"+cpu2/40.0);
					}
					Date b=new Date();
					end=b.getTime();
					use_time=end-start-2000;
					System.out.println("任务请求时间:"+use_time);
					if(count>1){
						task_time=task_time+use_time;
					}				
					if(count==40){
						System.out.println("平均响应时间:"+task_time/39.0);
					}
				}
				else{
...
*/	            
				...
				Shell.exec(ip_target, "ubuntu", "ubuntu", 22, "mysql -uroot -proot -e \"use test;call proc1;\"");
